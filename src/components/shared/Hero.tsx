    ...
    <section  className="bg-gradient-to-r from-white/95 to-red-100/5 py-8 sm:py-12" aria-labelledby="hero-heading">
      <div className="w-full max-w-7xl  lg:pl-12 mx-auto px-4 sm:px-6 md:px-8">
        <div  className="flex flex-col lg:flex-row lg:space-x-8">
          <div className={`order-3 lg:order-1 max-w-xl lg:w-[48%] ${local=="ar"?"lg:text-right":"lg:text-left"} `}>
            <h1 id="hero-heading" 
            className={`pt-6 lg:p-0 text-center ${local=="ar"?"lg:text-right":"lg:text-left"}  text-2xl md:text-5xl font-extrabold uppercase`}>
              {t('heroHeading')}
